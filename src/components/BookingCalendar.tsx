    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3.5">
        ...
        <div className="relative">
          <div role="menubar" tabIndex={0} className="grid grid-cols-3 gap-x-3.5" aria-label={labels.selectDate}>
            {availabilityState === "ready" && !isTodayAvailable && !isTomorrowAvailable ? (
              ...
              <>
                {isTodayAvailable && (
                  ...
                  >
                    <span className="text-lg leading-6 font-bold">{todayStr.slice(8, 10)}</span>
          ...
          {/* Calendar dropdown */}
          {calendarOpen && (
            <div ref={calendarRef} className="absolute inset-x-0 top-full z-50 mt-4 md:max-w-md">
              <div className="overflow-hidden rounded-md bg-white px-1 pb-2 align-middle shadow-[0_0_20px_rgba(0,0,0,0.12)]">
                <div className="pt-6">
                  {/* Month navigation */}
                  <nav className="flex items-center justify-between px-6">
                    <button
                      ...
                      className={[
                        "inline-flex h-7 w-7 items-center justify-center rounded-full hover:shadow-sm",
                    ...
                    <button
                      ...
                      className="inline-flex h-7 w-7 items-center justify-center rounded-full hover:shadow-sm"
                    >
                      <ChevronRight />
                    </button>
                  </nav>
                  ...
                  <div className="mt-4 grid grid-cols-7 justify-items-center gap-1">
                    {calendarDays.map((day, index) => {
                      ...
                      if (isUnavailable) {
                        return (
                          ...
                          >
                            ...
                            <span className="invisible mt-px text-xs">¥{price}</span>
                          </button>
                        );
                      }
                      ...
                      return (
                        ...
                        >
                          <span className="text-lg leading-6 font-bold text-ink">{dayNumber}</span>
                          <span className="mt-px text-xs text-secondary">¥{price}</span>
                        </button>
                      );
                    })}
                  </div>
      ...
      {/* Status text */}
      <div className="min-h-5 text-xs font-medium text-secondary">
