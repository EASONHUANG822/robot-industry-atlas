          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
            {[
              ...
              <div key={label} className="flex items-center gap-3">
                {i > 0 && <div className="hidden h-5 w-px bg-line sm:block" aria-hidden="true" />}
                <span>
                  <span className="text-2xl font-black text-accent sm:text-3xl">{value}</span>
                  <span className="ml-1.5 text-sm font-semibold uppercase tracking-wide text-muted">{label}</span>
                </span>
              </div>
            ))}
          </div>
